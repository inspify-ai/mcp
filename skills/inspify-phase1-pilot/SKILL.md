...
- The 16 ALLOWED tools (see creative-agency-mcp skill).
- Writes: confirm-before-send; publish human-in-command.
- Deep-link humans to Hub Scene Designer (URL only). Lead: Scene Designer first.

## Out
- Hub draft MCP aliases; customer agents / customer GA claims.
- §11; Host/Mac Shell; AWS Admin keys; Chair disk wipe.
